...
/**
 * Test suite for the class {@link MadsEngine}.
 * 
 * @author Massimo Coluzzi
 */
@DisplayNameGeneration(DisplayNameGenerator.ReplaceUnderscores.class)
public class MadsEngineTests
{
    ...
    public void removing_more_buckets_than_available_will_not_throw_any_error()
    {
        ...
        final MadsEngine engine = new MadsEngine( 0, 10, ConsistentHash.DEFAULT_HASH_FUNCTION );
    ...
    public void if_the_cluster_has_one_node_all_the_keys_should_land_to_such_a_node()
    {
        ...
        final MadsEngine engine = new MadsEngine( 1, 10, ConsistentHash.DEFAULT_HASH_FUNCTION );
        for( int i = 0; i < 100; ++i )
        {
    ...
    private void recordOriginalKeyPositions( List<String> keys, int iterations, Map<String,int[]> map, MadsEngine engine )
    {
    ...
    private void recordKeyPositions( List<String> keys, int iteration, Map<String,int[]> map, MadsEngine engine )
    {
