...
/**
 * Suite to test the {@link MadsFactory} class.
 * 
 * @author Massimo Coluzzi
 */
@DisplayNameGeneration(DisplayNameGenerator.ReplaceUnderscores.class)
public class MadsFactoryTests implements ConsistentHashFactoryContract<MadsFactory>
{
     ...
     */
    @Override
    public MadsFactory sampleValue( AlgorithmConfig config )
    {

        return new MadsFactory( config );
    ...
    public void passing_empty_configuration_should_take_default_capacity()
    {
        ...
        final MadsFactory factory = sampleValue( CONFIG );
        
        final Supplier<MadsEngine> supplier = factory.createEngineInitializer( FUNCTION, NODES );
        assertNotNull( supplier );

        final MadsEngine engine = supplier.get();
