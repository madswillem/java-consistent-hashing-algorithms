...
/**
 * Wrapper to adapt the {@link MadsEngine} to the {@link ConsistentHash} interface.
 * 
...
public class MadsHash implements ConsistentHash
{
     ...
     */
    public MadsHash( Collection<? extends Node> nodes, int capacity )
    {
     ...
     */
    public MadsHash( Collection<? extends Node> nodes, int capacity, HashFunction hashFunction )
    {
