 ...
 * This version fixes the size of the cluster and increases the rate of removed nodes.
 * 
 * @author Massimo Coluzzi
 */
public class IncrementalResizeTime extends BenchmarkExecutor
{
     ...
     */
    public IncrementalResizeTime( BenchmarkConfig config )
    {
    ...
    protected void performBenchmak( List<ConsistentHashFactory> factories ) throws Exception
    {
        ...
        final Options opt = new OptionsBuilder()
            .include( IncrementalResizeTime.IncrementalResizeTimeExecutor.class.getCanonicalName() )
    ...
    public static class IncrementalResizeTimeExecutor<N>
    {
        ...
        /** The pilot where to invoke the add/remove node functions on. */
        ...
        public void setup( JMHConfigWrapper wrapper )
        {
            ...
            this.pilot = (ConsistentHashEnginePilot<N>) factory.createEnginePilot( consistentHash );
